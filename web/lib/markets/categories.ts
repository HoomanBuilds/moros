...
export const EVENT_SOURCE_GUIDANCE: Record<EventCategory, {
  ...
  Equities: {
    subjectLabel: "Company or ticker",
    subjectPlaceholder: "Apple (AAPL)",
  ...
  Commodities: {
    subjectLabel: "Commodity or benchmark",
    subjectPlaceholder: "Brent crude oil",
  ...
  Sports: {
    subjectLabel: "Team, player, league, or event",
    subjectPlaceholder: "India national cricket team",
  ...
  Economics: {
    subjectLabel: "Indicator and geography",
    subjectPlaceholder: "United States consumer price index",
  ...
  Weather: {
    subjectLabel: "Location or weather station",
    subjectPlaceholder: "Heathrow Airport weather station",
  ...
  Politics: {
    subjectLabel: "Candidate, office, jurisdiction, or measure",
    subjectPlaceholder: "New York City mayoral election",
  ...
  Technology: {
    subjectLabel: "Company, product, project, or standard",
    subjectPlaceholder: "Ethereum Fusaka upgrade",
  ...
  Entertainment: {
    subjectLabel: "Event, title, artist, or nominee",
    subjectPlaceholder: "Academy Award for Best Picture",
  ...
  Other: {
    ...
    subjectPlaceholder: "Name the person, place, organization, or event",
...
export function isMarketCategory(category?: string | null): category is MarketCategory {
  return !!category && (MARKET_CATEGORIES as readonly string[]).includes(category);
}
